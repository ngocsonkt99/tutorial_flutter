                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: (isLoad == true) ? CircularProgressIndicator(backgroundColor: Colors.orangeAccent,) 
                                    : Text("Loading", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 25),),
                                  ),
                                ),
                            ),
                          )
          ...
          return Container(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  Center(
                    child: Text("Upload Image", style: TextStyle(color: Colors.green, fontSize: 25, fontWeight: FontWeight.bold),)
                  ),
                  Divider(thickness: 2,),
                  SizedBox(height: 30,),
                  RaisedButton(
